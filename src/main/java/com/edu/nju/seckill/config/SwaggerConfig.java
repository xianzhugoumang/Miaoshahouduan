...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo(){
        //name,url,email
        Contact contact=new Contact("zmz","https://blog.csdn.net/Conqueror_","1558821214@qq.com");
        ...
        return new ApiInfo("SecKill API",
                new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())+
                        "今天又是努力学习的一天哦！","v1.0",
                "http://localhost:8080/",contact,"Apache 2.0", "http://www.apache.org/licenses/LICENSE-2.0",
